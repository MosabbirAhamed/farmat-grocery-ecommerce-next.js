    ...
    <div>
      ...
      <div className="bg-gray-100 p-5 rounded-md">
        ...
        <div className="space-y-3 bg-white">
          ...
          {cartItems.map((item, i) => (
            <div key={i} className="flex justify-between py-5 px-5 border-b">
              ...
              <h2 className="text-base font-bold ml-2">${(item.price * item.quantity).toFixed(2)}</h2>
            </div>
          ))}
        </div>
        <div className="flex justify-between py-5 border-b">
          <h2 className="text-base font-bold">Subtotal</h2>
          <h2 className="text-base font-bold text-green">${totalPrice}</h2>
        </div>
        ...
        <div className="flex justify-between py-5 border-b">
          ...
          <h2 className="text-lg font-bold text-green">${totalPrice}</h2>
        </div>
        <div className="pt-5">
