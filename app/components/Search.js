...
const Search = () => {
  return (
    <div className="bg-gray-100 p-3 rounded-lg hidden md:flex items-center gap-2 lg:min-w-[650px] mx-4">
    ...
    <input className="outline-none bg-transparent px-4 border-l border-gray-400 flex-1" type="text" placeholder="I'm searching for ..." />
